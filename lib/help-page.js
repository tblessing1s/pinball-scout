...
function renderTastePivot() {
  ...
  return `
    <section class="discovery-shell">
      ...
      <div class="taste-pivot-grid">
        <article class="taste-pivot-card panel" data-action="taste-pivot-expand:${pairIndex}:left">
          ...
          <button class="btn btn-primary taste-pivot-pick-btn" type="button" data-action="taste-pivot-pick:${pairIndex}:left">This sounds like me</button>
        </article>
        <div class="taste-pivot-or"><span>or</span></div>
        <article class="taste-pivot-card panel" data-action="taste-pivot-expand:${pairIndex}:right">
          ...
          <button class="btn btn-primary taste-pivot-pick-btn" type="button" data-action="taste-pivot-pick:${pairIndex}:right">This sounds like me</button>
        </article>
      </div>
      ${hasAnyScore ? `
...
root?.addEventListener("click", (event) => {
  ...
  if (action?.startsWith("taste-pivot-expand:")) {
    const card = event.target.closest(".taste-pivot-card");
    const grid = card?.closest(".taste-pivot-grid");
    if (!card || !grid) return;
    const wasExpanded = card.classList.contains("is-expanded");
    grid.querySelectorAll(".taste-pivot-card").forEach((c) => c.classList.remove("is-expanded"));
