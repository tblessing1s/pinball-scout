...
function renderBracketNearby() {
  ...
  const renderNearbySection = () => {
    if (!hasLocationSearch) {
      return `
        <div class="panel bracket-nearby-prompt">
          <h3>Can you play your champion nearby?</h3>
          <p class="muted">We'll check Pinball Map to see if ${champion ? machineDisplayTitle(champion) : "your top pick"} — or something close to it — is playable near you.</p>
          <button class="btn btn-secondary" type="button" data-action="bracket-nearby-buy">
            Skip to buying plan
          </button>
          <p class="muted small">You can search locations in the buying plan.</p>
        </div>
      `;
    }
