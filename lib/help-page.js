...
function renderResults() {
  ...
  return `
    <section class="discovery-shell">
      ...
      <article class="panel results-next-step">
        <p class="eyebrow">Refine your shortlist</p>
        <h3>Use quick video or proxy testing to sharpen the order</h3>
        <p class="muted">Simple feedback on 1-2 experiences will tighten the top 3.</p>
        <div class="card-actions">
          <button class="btn btn-secondary" type="button" data-action="open-video-refinement">Watch quick videos</button>
          <button class="btn btn-secondary" type="button" data-action="open-nearby">Plan nearby test</button>
          <button class="btn btn-secondary" type="button" data-action="open-finals">Open finals</button>
        </div>
      </article>
    ...
    <section class="discovery-shell">
      ...
      <article class="panel">
        ...
        <div class="card-actions">
          ...
          ${brief.links?.market ? `<a class="btn btn-secondary" href="${brief.links.market}" target="_blank" rel="noreferrer">Open used listings</a>` : ""}
