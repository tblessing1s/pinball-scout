...
const TASTE_PIVOT_PAIRS = [
  {
    ...
    left: {
      ...
      scores: { "learning-curve": -2, "pace-feel": -1, "replay": -1 }
    },
    right: {
      ...
      scores: { "learning-curve": 2, "challenge": 1, "replay": 1 }
    }
  },
  {
    ...
    left: {
      ...
      scores: { "theme-pull": -2, "challenge": 1, "pace-feel": -1 }
    },
    right: {
      ...
      scores: { "theme-pull": 2, "ownership": -1 }
    }
  },
  {
    ...
    left: {
      ...
      scores: { "challenge": -1, "replay": -2, "ownership": -1 }
    },
    right: {
      ...
      scores: { "learning-curve": 1, "replay": 2, "ownership": 1 }
    }
  }
];
...
function renderTasteScale(scale, score, compact = false) {
  const isSet = score !== 0;
  const clampedPct = Math.max(6, Math.min(94, Math.round(((score + 4) / 8) * 100)));
...
function renderTasteProfileReveal() {
  ...
  return `
    <section class="discovery-shell">
      ${renderProgress(
        "Your player profile",
        "Based on your picks, here is how you lean.",
        82,
        archetype.name
      )}
