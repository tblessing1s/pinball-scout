...
export const ANALYTICS_EVENTS = {
  ...
  VIDEO_REFINEMENT_OPENED: "video_refinement_opened",
  VIDEO_REFINEMENT_SUBMITTED: "video_refinement_submitted",
  EXTERNAL_FEEDBACK_SUBMITTED: "external_feedback_submitted",
  FINALS_OPENED: "finals_opened",
  REFINEMENT_RECO_CHANGED: "refinement_reco_changed",
  DECISION_BRIEF_AFTER_REFINEMENT: "decision_brief_after_refinement"
};
...
export const ANALYTICS_SCHEMAS = {
  ...
  [ANALYTICS_EVENTS.VIDEO_REFINEMENT_OPENED]: ["candidate_count"],
  [ANALYTICS_EVENTS.VIDEO_REFINEMENT_SUBMITTED]: ["candidate_count"],
  [ANALYTICS_EVENTS.EXTERNAL_FEEDBACK_SUBMITTED]: ["machine_name"],
  [ANALYTICS_EVENTS.FINALS_OPENED]: ["candidate_count"],
  [ANALYTICS_EVENTS.REFINEMENT_RECO_CHANGED]: ["source", "from_top", "to_top"],
  [ANALYTICS_EVENTS.DECISION_BRIEF_AFTER_REFINEMENT]: ["machine_slug"]
};
